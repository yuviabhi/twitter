"""
Generating inputs feed to train the RBM
Dataset : using random points from waterbodies buffer area 
...
def main():
	...
	file_latlons = '/home/abhisek/Documents/abhisek-workspace/codes/twitter/waterbodies/random-points-in-bufferzone.csv'
